...
class _AttendanceListScreenState extends State<AttendanceListScreen> {
            ...
            Row(
              ...
              children: [
                ...
                PopupMenuButton<AttendanceSortOption>(
                  ...
                  itemBuilder: (context) => [
                    _buildSortMenuItem(AttendanceSortOption.highest, 'Highest Attendance First'),
                    _buildSortMenuItem(AttendanceSortOption.lowest, 'Lowest Attendance First'),
                    _buildSortMenuItem(AttendanceSortOption.name, 'School Name (A-Z)'),
                    _buildSortMenuItem(AttendanceSortOption.students, 'Student Count (High-Low)'),
                  ],
                ),
              ],
            ),
  ...
  PopupMenuItem<AttendanceSortOption> _buildSortMenuItem(
    AttendanceSortOption value,
    String label,
  ) {
    final isSelected = _sortOption == value;
    return PopupMenuItem<AttendanceSortOption>(
      value: value,
      child: Row(
        children: [
          Icon(
